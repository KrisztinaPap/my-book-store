    ...
    render() {
        return (
            <div className="container">
                <nav className="navbar navbar-expand-sm px-sm-5 justify-content-between">
                    <div className="navbar-brand">
                        <Link to='/'>
                            <svg width="1.4em" height="1.4em" viewBox="0 0 16 16" class="bi bi-flower1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul className="navbar-nav">
                        ...
                        <Link to="/cart" className="nav-item nav-link">
                            <svg width="1.8em" height="1.8em" viewBox="0 0 16 16" class="bi bi-cart4" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
